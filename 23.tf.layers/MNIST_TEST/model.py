...
class Model():
    ...
    def forward(self,input,regularizer):
        ...
        logits_conv1=tf.layers.conv2d(
            ...
            kernel_regularizer=regularizer,bias_regularizer=regularizer,name="conv_1"
        )
        ...
        logits_conv2 = tf.layers.conv2d(
            ...
            kernel_regularizer=regularizer, bias_regularizer=regularizer, name="conv_2"
        )
        print("shape of logits_conv2:", logits_conv2.shape)
        logits_conv2 = tf.layers.max_pooling2d(inputs=logits_conv2, pool_size=2, strides=2, padding="SAME",
                                               name="padded_conv2")
        print("shape of logits_conv2:", logits_conv2.shape)
        ...
        logits=tf.layers.dense(inputs=logits_flatten,units=10,activation=tf.nn.relu,kernel_regularizer=regularizer,
                               bias_regularizer=regularizer,name="logits")
